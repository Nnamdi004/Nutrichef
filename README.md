...
- **Web01**: 54.90.50.233
- **Web02**: 100.26.232.98
- **Load Balancer**: 54.236.50.227

### Deploy to Web01

```bash
# SSH into server
ssh ubuntu@54.90.50.233
...
scp index.html ubuntu@54.90.50.233:/var/www/nutrichef/
scp css/style.css ubuntu@54.90.50.233:/var/www/nutrichef/css/
scp js/config.js ubuntu@54.90.50.233:/var/www/nutrichef/js/
scp js/app.js ubuntu@54.90.50.233:/var/www/nutrichef/js/

# Copy Nginx config
scp config/nginx-site.conf ubuntu@54.90.50.233:/tmp/
...
ssh ubuntu@54.236.50.227

# Install HAProxy
sudo apt update && sudo apt install haproxy -y

# Copy configuration
scp config/haproxy.cfg ubuntu@54.236.50.227:/tmp/
...
curl -I http://54.90.50.233
curl -I http://100.26.232.98

# Test load balancer
curl -I http://54.236.50.227

# View HAProxy stats
# Open browser: http://54.236.50.227:8080/haproxy?stats
...
backend nutrichef_servers
    balance roundrobin
    option httpchk GET /
    server web01 54.90.50.233:80 check
    server web02 100.26.232.98:80 check
...
### ✅ Deployment
- Deployed to Web01 (54.90.50.233)
- Deployed to Web02 (100.26.232.98)
- HAProxy load balancer configured (54.236.50.227)
...
# Deploy Web01
scp -r * ubuntu@54.90.50.233:/var/www/nutrichef/

# Deploy Web02
scp -r * ubuntu@100.26.232.98:/var/www/nutrichef/
